...
public class MatricesMultiplication {
    private static final String INPUT_FILE = "./out/multithreading/inter_thread_communication/matrices.txt";
    private static final String OUTPUT_FILE = "./out/multithreading/inter_thread_communication/matrices_results.txt";
